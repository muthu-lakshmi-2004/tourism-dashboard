...
export default function DonationPage() {
  ...
  // Client-side filter (same pattern as GangaBoatPage)
  ...
  const totalRevenue = filtered.reduce((s, d) => s + parseFloat(d.price || "0"), 0);
    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto px-2 sm:px-4">
        ...
        <motion.div
          ...
          className="bg-card border border-border/50 rounded-[16px] p-4 ceramic-shadow mb-6
        ...
        >
          ...
          <div className="flex items-center gap-2 min-w-0">
            ...
            <input
              ...
              className="border border-border/60 rounded-md px-3 py-1.5 text-sm bg-background
                         focus:outline-none focus:ring-2 focus:ring-primary/30 w-full sm:w-auto"
            />
          </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              {[
                ...
                {
                  label: "Prasadam Sent",
                  value: prasadamSent.toLocaleString(),
                },
              ].map((m, i) => (
                <motion.div
                  key={m.label}
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="py-4 px-3 text-right tabular-nums whitespace-nowrap">
                              {d.puja_date
                                ? format(
                                    parse(d.puja_date, "yyyy-MM-dd", new Date()),
                                    "dd MMM yyyy",
                                  )
                                : "—"}
                            </td>
